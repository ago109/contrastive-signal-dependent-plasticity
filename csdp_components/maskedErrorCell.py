...
def run_cell(dt, targ, mu, mask=1., eType="gaussian"):
    """
    ...
    """
    return run_gaussian_cell(dt, targ, mu, mask)

@jit
def run_gaussian_cell(dt, targ, mu, mask):
    """
    ...
    Args:
        ...
        mask: binary mask indicating how many values to use
...
class MaskedErrorCell(Component): ## Rate-coded/real-valued error unit/cell
    """
    ...
    @classmethod
    def labelMaskName(cls):
        return 'lab'

    ## Bind Properties to Compartments for ease of use
    @property
    def maskLabels(self):
        return self.compartments.get(self.labelMaskName(), None)

    @maskLabels.setter
    def maskLabels(self, inp):
        self.compartments[self.labelMaskName()] = inp
    ...
    def advance_state(self, t, dt, **kwargs):
        ...
        self.derivMean, self.derivTarget, self.loss = \
            run_cell(dt, self.target, self.mean, self.maskLabels)
    ...
    def reset(self, **kwargs):
        ...
        self.modulator = None
        self.maskLabels = jnp.ones((self.batch_size, 1))
